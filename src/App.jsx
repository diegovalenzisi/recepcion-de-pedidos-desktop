        ...
        <main className={`flex-grow min-h-0 ${location.pathname.startsWith('/atencion') ? 'flex flex-col overflow-hidden p-2' : 'container mx-auto p-4 overflow-y-auto'}`}>
          <Suspense fallback={<LoadingFallback />}>
            <Routes location={backgroundLocation || location}>
              ...
              <Route path="/stock" element={<ProtectedRoute name="Stock" permissions={['stock', 'articulos', 'materiaPrima', 'gruposOpcionales', 'opcionales', 'departamentos', 'tachos', 'tachos_modificar_stock', 'stock_consulta_general']} userPermissions={userPermissions} userRole={userRole}><StockPage userPermissions={userPermissions} userRole={userRole} /></ProtectedRoute>} />
